...
/**
 * Activator for {@link io.helidon.examples.pico.book.UlyssesInGreen}.
 */
// @Singleton 
@SuppressWarnings("unchecked")
@Generated(value = "io.helidon.pico.tools.ActivatorCreatorDefault", comments = "version=1")
public class UlyssesInGreen$$Pico$$Activator
            extends io.helidon.pico.runtime.AbstractServiceProvider<UlyssesInGreen> {
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            .serviceTypeName(io.helidon.examples.pico.book.UlyssesInGreen.class.getName())
            .addContractsImplemented(io.helidon.examples.pico.book.Book.class.getName())
            .activatorTypeName(UlyssesInGreen$$Pico$$Activator.class.getName())
     ...
     */
    public static final UlyssesInGreen$$Pico$$Activator INSTANCE = new UlyssesInGreen$$Pico$$Activator();

    /**
     * Default activator constructor.
     */
    protected UlyssesInGreen$$Pico$$Activator() {
    ...
    public Class<?> serviceType() {
        return io.helidon.examples.pico.book.UlyssesInGreen.class;
    }

    @Override
    public DependenciesInfo dependencies() {
        DependenciesInfo deps = Dependencies.builder(io.helidon.examples.pico.book.UlyssesInGreen.class.getName())
                .build();
        return Dependencies.combine(super.dependencies(), deps);
    }

    @Override
    protected UlyssesInGreen createServiceProvider(Map<String, Object> deps) { 
        return new io.helidon.examples.pico.book.UlyssesInGreen();
    }
