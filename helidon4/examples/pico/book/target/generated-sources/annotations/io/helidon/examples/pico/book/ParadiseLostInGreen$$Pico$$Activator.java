...
/**
 * Activator for {@link io.helidon.examples.pico.book.ParadiseLostInGreen}.
 */
// @Singleton 
@SuppressWarnings("unchecked")
@Generated(value = "io.helidon.pico.tools.ActivatorCreatorDefault", comments = "version=1")
public class ParadiseLostInGreen$$Pico$$Activator
            extends io.helidon.pico.runtime.AbstractServiceProvider<ParadiseLostInGreen> {
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            .serviceTypeName(io.helidon.examples.pico.book.ParadiseLostInGreen.class.getName())
            .addContractsImplemented(io.helidon.examples.pico.book.Book.class.getName())
            .activatorTypeName(ParadiseLostInGreen$$Pico$$Activator.class.getName())
     ...
     */
    public static final ParadiseLostInGreen$$Pico$$Activator INSTANCE = new ParadiseLostInGreen$$Pico$$Activator();

    /**
     * Default activator constructor.
     */
    protected ParadiseLostInGreen$$Pico$$Activator() {
    ...
    public Class<?> serviceType() {
        return io.helidon.examples.pico.book.ParadiseLostInGreen.class;
    }

    @Override
    public DependenciesInfo dependencies() {
        DependenciesInfo deps = Dependencies.builder(io.helidon.examples.pico.book.ParadiseLostInGreen.class.getName())
                .build();
        return Dependencies.combine(super.dependencies(), deps);
    }

    @Override
    protected ParadiseLostInGreen createServiceProvider(Map<String, Object> deps) { 
        return new io.helidon.examples.pico.book.ParadiseLostInGreen();
    }
