...
/**
 * Activator for {@link io.helidon.examples.pico.book.BookCase}.
 */
// @Singleton 
@SuppressWarnings("unchecked")
@Generated(value = "io.helidon.pico.tools.ActivatorCreatorDefault", comments = "version=1")
public class BookCase$$Pico$$Activator
            extends io.helidon.pico.runtime.AbstractServiceProvider<BookCase> {
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            .serviceTypeName(io.helidon.examples.pico.book.BookCase.class.getName())
            .addContractsImplemented(io.helidon.examples.pico.book.BookHolder.class.getName())
            .activatorTypeName(BookCase$$Pico$$Activator.class.getName())
     ...
     */
    public static final BookCase$$Pico$$Activator INSTANCE = new BookCase$$Pico$$Activator();

    /**
     * Default activator constructor.
     */
    protected BookCase$$Pico$$Activator() {
    ...
    public Class<?> serviceType() {
        return io.helidon.examples.pico.book.BookCase.class;
    }

    @Override
    public DependenciesInfo dependencies() {
        DependenciesInfo deps = Dependencies.builder(io.helidon.examples.pico.book.BookCase.class.getName())
                .add("allBooks", io.helidon.examples.pico.book.Book.class, ElementKind.FIELD, Access.PACKAGE_PRIVATE).elemOffset(null).listWrapped().providerWrapped()
                .build();
        return Dependencies.combine(super.dependencies(), deps);
    }

    @Override
    protected BookCase createServiceProvider(Map<String, Object> deps) { 
        return new io.helidon.examples.pico.book.BookCase();
    }
    ...
    protected void doInjectingFields(Object t, Map<String, Object> deps, Set<String> injections, String forServiceType) {
        ...
        BookCase target = (BookCase) t;
        target.allBooks = (List<Provider<io.helidon.examples.pico.book.Book>>) get(deps, "io.helidon.examples.pico.book.allBooks");
    }
