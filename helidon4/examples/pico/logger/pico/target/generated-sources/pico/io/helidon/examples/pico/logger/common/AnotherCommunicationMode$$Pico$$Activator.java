...
/**
 * Activator for {@link io.helidon.examples.pico.logger.common.AnotherCommunicationMode}.
 */
// @Singleton 
@SuppressWarnings("unchecked")
@Generated(value = "io.helidon.pico.tools.ActivatorCreatorDefault", comments = "version=1")
public class AnotherCommunicationMode$$Pico$$Activator
            extends io.helidon.pico.runtime.AbstractServiceProvider<AnotherCommunicationMode> {
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            .serviceTypeName(io.helidon.examples.pico.logger.common.AnotherCommunicationMode.class.getName())
            .addExternalContractsImplemented(io.helidon.examples.pico.logger.common.CommunicationMode.class.getName())
            .activatorTypeName(AnotherCommunicationMode$$Pico$$Activator.class.getName())
     ...
     */
    public static final AnotherCommunicationMode$$Pico$$Activator INSTANCE = new AnotherCommunicationMode$$Pico$$Activator();

    /**
     * Default activator constructor.
     */
    protected AnotherCommunicationMode$$Pico$$Activator() {
    ...
    public Class<?> serviceType() {
        return io.helidon.examples.pico.logger.common.AnotherCommunicationMode.class;
    }

    @Override
    public DependenciesInfo dependencies() {
        DependenciesInfo deps = Dependencies.builder(io.helidon.examples.pico.logger.common.AnotherCommunicationMode.class.getName())
    ...
    @Override
    protected AnotherCommunicationMode createServiceProvider(Map<String, Object> deps) { 
        return new io.helidon.examples.pico.logger.common.AnotherCommunicationMode();
    }
    ...
    protected void doInjectingFields(Object t, Map<String, Object> deps, Set<String> injections, String forServiceType) {
        ...
        AnotherCommunicationMode target = (AnotherCommunicationMode) t;
