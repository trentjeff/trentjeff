...
/**
 * Activator for {@link io.helidon.examples.pico.logger.common.ImCommunicationMode}.
 */
// @Singleton 
@SuppressWarnings("unchecked")
@Generated(value = "io.helidon.pico.tools.ActivatorCreatorDefault", comments = "version=1")
public class ImCommunicationMode$$Pico$$Activator
            extends io.helidon.pico.runtime.AbstractServiceProvider<ImCommunicationMode> {
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            .serviceTypeName(io.helidon.examples.pico.logger.common.ImCommunicationMode.class.getName())
            .addExternalContractsImplemented(io.helidon.examples.pico.logger.common.CommunicationMode.class.getName())
            .activatorTypeName(ImCommunicationMode$$Pico$$Activator.class.getName())
            .addScopeTypeName(jakarta.inject.Singleton.class.getName())
            .addQualifier(io.helidon.pico.api.QualifierAndValueDefault.create(jakarta.inject.Named.class, "im"))
            .build();

    /**
     * The global singleton instance for this service provider activator.
     */
    public static final ImCommunicationMode$$Pico$$Activator INSTANCE = new ImCommunicationMode$$Pico$$Activator();

    /**
     * Default activator constructor.
     */
    protected ImCommunicationMode$$Pico$$Activator() {
    ...
    public Class<?> serviceType() {
        return io.helidon.examples.pico.logger.common.ImCommunicationMode.class;
    }

    @Override
    public DependenciesInfo dependencies() {
        DependenciesInfo deps = Dependencies.builder(io.helidon.examples.pico.logger.common.ImCommunicationMode.class.getName())
    ...
    @Override
    protected ImCommunicationMode createServiceProvider(Map<String, Object> deps) { 
        return new io.helidon.examples.pico.logger.common.ImCommunicationMode();
    }
    ...
    protected void doInjectingFields(Object t, Map<String, Object> deps, Set<String> injections, String forServiceType) {
        ...
        ImCommunicationMode target = (ImCommunicationMode) t;
