...
/**
 * Activator for {@link io.helidon.examples.pico.logger.common.SmsCommunicationMode}.
 */
// @Singleton 
...
public class SmsCommunicationMode$$Pico$$Activator
    ...
    private static final ServiceInfoDefault serviceInfo =
        ServiceInfoDefault.builder()
            ...
            .addQualifier(io.helidon.pico.api.QualifierAndValueDefault.create(jakarta.inject.Named.class, "sms"))
            .build();
