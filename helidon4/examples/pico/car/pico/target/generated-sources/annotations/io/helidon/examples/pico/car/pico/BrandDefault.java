...
/**
 * Concrete implementation w/ builder for {@link io.helidon.examples.pico.car.pico.Brand}.
 */
@Generated(value = "io.helidon.builder.processor.tools.DefaultBuilderCreatorProvider", comments = "version=1")
@SuppressWarnings("unchecked")	
public class BrandDefault extends io.helidon.examples.pico.car.pico.BrandBase {
	 ...
	 *
	 * @return a builder for {@link io.helidon.examples.pico.car.pico.Brand}
	 */
	 ...
	 * @return a builder for {@link io.helidon.examples.pico.car.pico.Brand}
	 */
	public static Builder toBuilder(io.helidon.examples.pico.car.pico.Brand val) {
	 ...
	 *
	 */
	public static class Builder extends io.helidon.examples.pico.car.pico.BrandBase.Builder<Builder, io.helidon.examples.pico.car.pico.Brand> {
		/**
		 ...
		 */
		public io.helidon.examples.pico.car.pico.BrandDefault build() {
			Builder b = this;
