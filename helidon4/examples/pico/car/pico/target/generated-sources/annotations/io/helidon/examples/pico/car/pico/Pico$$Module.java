...
public final class Pico$$Module implements ModuleComponent { 
    ...
    public void configure(ServiceBinder binder) {
        binder.bind(io.helidon.examples.pico.car.pico.BrandProvider$$Pico$$Activator.INSTANCE);
        binder.bind(io.helidon.examples.pico.car.pico.Car$$Pico$$Activator.INSTANCE);
        binder.bind(io.helidon.examples.pico.car.pico.EngineProvider$$Pico$$Activator.INSTANCE);
